...
final class ProjectWxTool
{
    ...
    private static function updateOpenAuthorizerInfo(string $appId, array $data)
    {
        ...
        $openAuthorizer = SyBaseMysqlFactory::WxopenAuthorizerEntity();
    ...
    public static function getCorpProviderAuthorizerInfo(string $corpId)
    {
        ...
        $corpAuthorizer = SyBaseMysqlFactory::WxproviderCorpAuthorizerEntity();
    ...
    {
        $nowTime = Tool::getNowTime();
        $entity = SyBaseMysqlFactory::WxproviderCorpAuthorizerEntity();

 ...
 * Time: 16:01
 */
namespace Wx\Account\Merchant\PostageTemplate;
...
class TemplateInfoId extends WxBaseAccount
{
    /**
     * 公众号ID
     * @var string
    ...
    {
        parent::__construct();
        $this->serviceUrl = 'https://api.weixin.qq.com/merchant/express/getbyid?access_token=';
        $this->appid = $appId;
    }

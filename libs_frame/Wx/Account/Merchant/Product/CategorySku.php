 ...
 * Time: 16:01
 */
namespace Wx\Account\Merchant\Product;
...
class CategorySku extends WxBaseAccount
{
    /**
     * 公众号ID
     * @var string
    ...
    {
        parent::__construct();
        $this->serviceUrl = 'https://api.weixin.qq.com/merchant/category/getsku?access_token=';
        $this->appid = $appId;
    }

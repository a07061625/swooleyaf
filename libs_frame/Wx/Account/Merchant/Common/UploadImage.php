 ...
 * Time: 16:01
 */
namespace Wx\Account\Merchant\Common;
...
class UploadImage extends WxBaseAccount
{
    ...
    public function getDetail() : array
    {
        ...
        $this->curlConfigs[CURLOPT_URL] = $this->serviceUrl . WxUtilAccount::getAccessToken($this->appid) . '&filename=' . urlencode($this->image_name);

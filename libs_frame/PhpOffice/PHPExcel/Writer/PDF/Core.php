...
abstract class PHPExcel_Writer_PDF_Core extends PHPExcel_Writer_HTML
{
    ...
    protected static $paperSizes = [
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_TABLOID => [792.00, 1224.00],   //    (11 in. by 17 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_LEDGER => [1224.00, 792.00],   //    (17 in. by 11 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_STANDARD_1 => [720.00, 1008.00],   //    (10 in. by 14 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_STANDARD_2 => [792.00, 1224.00],   //    (11 in. by 17 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_C => [1224.00, 1584.00],  //    (17 in. by 22 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_D => [1584.00, 2448.00],  //    (22 in. by 34 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_E => [2448.00, 3168.00],  //    (34 in. by 44 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_US_STANDARD_FANFOLD => [1071.00, 792.00],   //    (14.875 in. by 11 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_STANDARD_PAPER_3 => [1080.00, 792.00],   //    (15 in. by 11 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_LEGAL_EXTRA_PAPER => [667.80, 1080.00],   //    (9.275 in. by 15 in.)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_TABLOID_EXTRA_PAPER => [841.68, 1296.00],   //    (11.69 in. by 18 in.)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_SUPERA_SUPERA_A4_PAPER => [643.46, 1009.13],   //    (227 mm by 356 mm)
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_SUPERB_SUPERB_A3_PAPER => [864.57, 1380.47],   //    (305 mm by 487 mm)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A3_EXTRA_PAPER => [912.76, 1261.42],   //    (322 mm by 445 mm)
        ...
        PHPExcel_Worksheet_PageSetup::PAPERSIZE_A3_EXTRA_TRANSVERSE_PAPER => [912.76, 1261.42]    //    (322 mm by 445 mm)
    ];

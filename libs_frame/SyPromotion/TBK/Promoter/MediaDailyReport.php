...
/**
 * Class MediaDailyReport
 *
 * @package SyPromotion\TBK\Promoter
 */
class MediaDailyReport extends BaseTBK
{
    use SetPageNo2Trait;
    ...
    {
        parent::__construct();
        $this->setMethod('taobao.tbk.dg.media.daily.report');
        $this->reqData['page_no'] = 1;
        $this->reqData['page_size'] = 20;
        $this->reqData['return_fields'] = 'pub_id,name,sub_pub_id,sub_site_id,sub_adzone_id,biz_type,union_pv,union_uv,alipay_num,alipay_amt,pre_pub_share_fee';
        $this->reqData['report_type_id'] = 'union_media_daily_report';
    }

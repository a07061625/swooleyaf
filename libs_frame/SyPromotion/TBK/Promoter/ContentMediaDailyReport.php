...
/**
 * Class ContentMediaDailyReport
 *
 * @package SyPromotion\TBK\Promoter
 */
class ContentMediaDailyReport extends BaseTBK
{
    use SetPageNo2Trait;
    ...
    {
        parent::__construct();
        $this->setMethod('taobao.tbk.dg.content.media.daily.report');
        $this->reqData['page_no'] = 1;
        $this->reqData['page_size'] = 20;
        $this->reqData['return_fields'] = 'pub_id,name,sub_pub_id,sub_site_id,sub_adzone_id,biz_type,union_pv,union_uv,cm_settle_num,cm_settle_amt,cm_pub_share_fee,div_rule';
        $this->reqData['report_type_id'] = 'union_content_media_daily_report';
    }

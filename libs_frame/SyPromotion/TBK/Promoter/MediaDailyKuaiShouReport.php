...
/**
 * Class MediaDailyKuaiShouReport
 *
 * @package SyPromotion\TBK\Promoter
 */
class MediaDailyKuaiShouReport extends BaseTBK
{
    use SetPageNo2Trait;
    ...
    {
        parent::__construct();
        $this->setMethod('taobao.tbk.dg.media.kuaishou.daily.report');
        $this->reqData['page_no'] = 1;
        $this->reqData['page_size'] = 20;
        $this->reqData['return_fields'] = 'pub_id,sub_pub_id,sub_site_id,sub_adzone_id,union_pv,union_uv,cm_settle_num,cm_settle_amt,cm_pub_share_fee,div_rule';
        $this->reqData['report_type_id'] = 'union_media_daily_report_kuaishou';
    }

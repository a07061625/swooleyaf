...
class MediaMonthlyKuaiShouReport extends BaseTBK
{
    ...
    {
        parent::__construct();
        $this->setMethod('taobao.tbk.dg.media.kuaishou.monthly.report');
        $this->reqData['page_no'] = 1;
        $this->reqData['page_size'] = 20;
        $this->reqData['return_fields'] = 'pub_id,sub_pub_id,sub_site_id,sub_adzone_id,div_rule,total_alipay_amt,settle_amount';
        $this->reqData['report_type_id'] = 'union_media_monthly_report_kuaishou';
    }

...
class PermissionSet extends QiNiuBaseKodo
{
    /**
     * 空间名称
     * @var string
    ...
    public function setPrivate(int $private)
    {
        if (in_array($private, [0, 1])) {
            ...
            throw new KodoException('权限类型不合法', ErrorCode::QINIU_KODO_PARAM_ERROR);
        }
    }
    ...
    public function getDetail() : array
    {
        ...
        if (!isset($this->reqData['private'])) {
            throw new KodoException('权限类型不能为空', ErrorCode::QINIU_KODO_PARAM_ERROR);
        }

...
class FileLifeUpdate extends QiNiuBaseKodo
{
    /**
     * 空间名称
     * @var string
    ...
    public function setDeleteDays(int $deleteDays)
    {
        if ($deleteDays > 0) {
            ...
            throw new KodoException('删除天数不合法', ErrorCode::QINIU_KODO_PARAM_ERROR);
        }
    }
    ...
    public function getDetail() : array
    {
        ...
        if ($this->deleteDays < 0) {
            throw new KodoException('删除天数不能为空', ErrorCode::QINIU_KODO_PARAM_ERROR);
        }

 ...
 */
class PushMassRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Push', '2016-08-01', 'MassPush');
    }
    ...
    public function setPushTasks(array $pushTask)
    {
        ...
        foreach ($pushTask as $depth1 => $depth1Value) {
            $this->queryParameters['PushTask.' . ($depth1 + 1) . '.AndroidNotificationBarType'] =
                $depth1Value['AndroidNotificationBarType'];
            ...
            $this->queryParameters['PushTask.' . ($depth1 + 1) . '.AndroidNotificationBarPriority'] =
                $depth1Value['AndroidNotificationBarPriority'];
            ...
            $this->queryParameters['PushTask.' . ($depth1 + 1) . '.AndroidNotificationChannel'] =
                $depth1Value['AndroidNotificationChannel'];

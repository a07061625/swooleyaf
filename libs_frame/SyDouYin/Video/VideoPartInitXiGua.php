...
/**
 * 初始化分片上传获取upload_id。该接口适用于西瓜
 *
 * @package SyDouYin\Video
 */
class VideoPartInitXiGua extends BaseVideo
{
    public function __construct(string $clientKey)
    {
        parent::__construct($clientKey);
        $this->serviceUri = '/xigua/video/part/init/';
    }
    ...
    public function getDetail(): array
    {
        ...
        $this->reqData['access_token'] = $this->getAccessToken($this->reqData['open_id'], Util::SERVICE_HOST_TYPE_XIGUA);

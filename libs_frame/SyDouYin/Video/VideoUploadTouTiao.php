...
/**
 * 上传视频文件到文件服务器，获取视频文件video_id。该接口适用于头条
 *
 * @package SyDouYin\Video
 */
class VideoUploadTouTiao extends BaseVideo
{
    public function __construct(string $clientKey)
    {
        parent::__construct($clientKey);
        $this->serviceUri = '/toutiao/video/upload/';
    }
    ...
    public function getDetail(): array
    {
        ...
        $this->serviceUri .= '&access_token=' . urlencode($this->getAccessToken($this->reqData['open_id'], Util::SERVICE_HOST_TYPE_TOUTIAO));

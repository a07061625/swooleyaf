...
/**
 * 初始化分片上传获取upload_id。该接口适用于抖音
 *
 * @package SyDouYin\Video
 */
class VideoPartInit extends BaseVideo
{
    public function __construct(string $clientKey)
    {
        parent::__construct($clientKey);
        $this->serviceUri = '/video/part/init/';
    }
    ...
    public function getDetail(): array
    {
        ...
        $this->reqData['access_token'] = $this->getAccessToken($this->reqData['open_id'], Util::SERVICE_HOST_TYPE_DOUYIN);

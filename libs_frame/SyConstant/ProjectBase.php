...
class ProjectBase
{
    ...
    //校验器常量
    const VALIDATOR_TAG_PREFIX_STRING = 'string_'; //标识前缀-字符串
    const VALIDATOR_TAG_PREFIX_INT = 'int_'; //标识前缀-整数
    const VALIDATOR_TAG_PREFIX_DOUBLE = 'double_'; //标识前缀-浮点数
    ...
    const VALIDATOR_TYPE_STRING_REQUIRED = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_REQUIRED;
    const VALIDATOR_TYPE_STRING_MIN = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_MIN; //最小长度
    const VALIDATOR_TYPE_STRING_MAX = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_MAX; //最大长度
    const VALIDATOR_TYPE_STRING_REGEX = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_REGEX;
    const VALIDATOR_TYPE_STRING_PHONE = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_PHONE;
    const VALIDATOR_TYPE_STRING_TEL = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_TEL;
    const VALIDATOR_TYPE_STRING_EMAIL = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_EMAIL;
    const VALIDATOR_TYPE_STRING_URL = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_URL;
    const VALIDATOR_TYPE_STRING_JSON = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_JSON;
    const VALIDATOR_TYPE_STRING_SIGN = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_SIGN;
    const VALIDATOR_TYPE_STRING_BASE_IMAGE = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_BASE_IMAGE;
    const VALIDATOR_TYPE_STRING_IP = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_IP;
    const VALIDATOR_TYPE_STRING_LNG = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_LNG;
    const VALIDATOR_TYPE_STRING_LAT = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_LAT;
    const VALIDATOR_TYPE_STRING_NO_JS = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_NO_JS;
    const VALIDATOR_TYPE_STRING_NO_EMOJI = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_NO_EMOJI;
    const VALIDATOR_TYPE_STRING_ZH = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_ZH;
    const VALIDATOR_TYPE_STRING_ALNUM = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_ALNUM;
    const VALIDATOR_TYPE_STRING_ALPHA = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_ALPHA;
    const VALIDATOR_TYPE_STRING_DIGIT = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_DIGIT;
    const VALIDATOR_TYPE_STRING_LOWER = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_LOWER;
    const VALIDATOR_TYPE_STRING_UPPER = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_UPPER;
    const VALIDATOR_TYPE_STRING_DIGIT_LOWER = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_DIGIT_LOWER;
    const VALIDATOR_TYPE_STRING_DIGIT_UPPER = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_DIGIT_UPPER;
    const VALIDATOR_TYPE_STRING_FRAME_TOKEN = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_FRAME_TOKEN;
    const VALIDATOR_TYPE_STRING_JWT = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_JWT;
    const VALIDATOR_TYPE_STRING_REQUEST_RATE = self::VALIDATOR_TAG_PREFIX_STRING . self::VALIDATOR_TAG_REQUEST_RATE;
    const VALIDATOR_TYPE_INT_REQUIRED = self::VALIDATOR_TAG_PREFIX_INT . self::VALIDATOR_TAG_REQUIRED;
    const VALIDATOR_TYPE_INT_MIN = self::VALIDATOR_TAG_PREFIX_INT . self::VALIDATOR_TAG_MIN; //最小值
    const VALIDATOR_TYPE_INT_MAX = self::VALIDATOR_TAG_PREFIX_INT . self::VALIDATOR_TAG_MAX; //最大值
    const VALIDATOR_TYPE_INT_IN = self::VALIDATOR_TAG_PREFIX_INT . self::VALIDATOR_TAG_IN;
    const VALIDATOR_TYPE_INT_BETWEEN = self::VALIDATOR_TAG_PREFIX_INT . self::VALIDATOR_TAG_BETWEEN;
    const VALIDATOR_TYPE_DOUBLE_REQUIRED = self::VALIDATOR_TAG_PREFIX_DOUBLE . self::VALIDATOR_TAG_REQUIRED;
    const VALIDATOR_TYPE_DOUBLE_MIN = self::VALIDATOR_TAG_PREFIX_DOUBLE . self::VALIDATOR_TAG_MIN; //最小值
    const VALIDATOR_TYPE_DOUBLE_MAX = self::VALIDATOR_TAG_PREFIX_DOUBLE . self::VALIDATOR_TAG_MAX; //最大值
    const VALIDATOR_TYPE_DOUBLE_BETWEEN = self::VALIDATOR_TAG_PREFIX_DOUBLE . self::VALIDATOR_TAG_BETWEEN;

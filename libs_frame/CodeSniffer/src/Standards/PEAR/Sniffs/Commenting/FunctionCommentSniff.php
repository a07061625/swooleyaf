...
class FunctionCommentSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ('protected' === $scopeModifier
            && 'public' === $this->minimumVisibility
            || 'private' === $scopeModifier
            && ('public' === $this->minimumVisibility || 'protected' === $this->minimumVisibility)
        ) {
            return;
        }
        ...
        foreach ($params as $pos => $param) {
            ...
            if ($param['tag'] !== $param['comment_end']) {
                ...
                foreach ($param['comment_tokens'] as $commentToken) {
                    ...
                    $found = 0;
                    if (T_DOC_COMMENT_WHITESPACE === $tokens[($commentToken - 1)]['code']) {

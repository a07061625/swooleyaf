...
if (false === \defined('T_NAME_FULLY_QUALIFIED')) {
    \define('T_NAME_FULLY_QUALIFIED', 'PHPCS_T_NAME_FULLY_QUALIFIED');
}

if (false === \defined('T_NAME_RELATIVE')) {
...
final class Tokens
{
     ...
     *                                  type for.
     *
     * @return false|int The highest weighted token.
     */

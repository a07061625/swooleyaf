    ...
    public static function load(Ruleset $ruleset, Config $config)
    {
        ...
        $filter = new \RecursiveCallbackFilterIterator(
            ...
            function ($file, $key, $iterator) {
                ...
                if (true === $file->isFile() && '.php' !== substr($filename, -4)) {
                    return false;
                }
        ...
        if (null !== $config->cacheFile) {
            ...
            foreach ($config->files as $file) {
                ...
                while (\DIRECTORY_SEPARATOR !== $file) {
                    if (false === isset($paths[$file])) {
                        $paths[$file] = 1;
                    } else {
                        ++$paths[$file];
                    }
            ...
            if (false === $cacheDir || false === is_dir($cacheDir)) {

...
final class ErrorSuppressionTest extends TestCase
{
    ...
    public function testSuppressWarning()
    {
        ...
        static::assertSame(1, $numWarnings);
        ...
        $warnings = $file->getWarnings();
        $numWarnings = $file->getWarningCount();
        static::assertSame(0, $numWarnings);
    ...
    public function testEnableSelected()
    {
        ...
        static::assertSame(0, $numErrors);
        static::assertCount(0, $errors);
        static::assertSame(2, $numWarnings);

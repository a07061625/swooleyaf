 ...
 */
class EmployeePreEntryQuery extends TalkBaseCorp
{
    use TalkTraitCorp;
    ...
    {
        $this->curlConfigs[CURLOPT_URL] = $this->serviceDomain . '/topapi/smartwork/hrm/employee/querypreentry?' . http_build_query([

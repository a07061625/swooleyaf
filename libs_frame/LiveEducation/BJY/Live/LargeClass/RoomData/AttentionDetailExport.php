 ...
 */
class AttentionDetailExport extends BaseBJY
{
    /**
     * 房间ID
     * @var int
    ...
    public function setAttentionId(int $attentionId)
    {
        if ($attentionId > 0) {
            ...
            throw new BJYException('关注ID不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function getDetail() : array
    {
        ...
        if (!isset($this->reqData['attention_id'])) {
            throw new BJYException('关注ID不能为空', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }

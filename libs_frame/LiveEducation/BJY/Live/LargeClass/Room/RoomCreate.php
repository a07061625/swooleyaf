 ...
 */
class RoomCreate extends BaseBJY
{
    /**
     * 直播课标题,不超过50个字符或汉字
     * @var string
    ...
    public function setTitle(string $title)
    {
        ...
        if (strlen($trueTitle) > 0) {
            ...
            throw new BJYException('直播课标题不能为空', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setType(int $type)
    {
        if (in_array($type, [1, 2, 3])) {
            ...
            throw new BJYException('课程类型不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setMaxUsers(int $maxUsers)
    {
        if ($maxUsers >= 0) {
            ...
            throw new BJYException('普通大班课最大人数不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setPreEnterTime(int $preEnterTime)
    {
        if ($preEnterTime >= 0) {
            ...
            throw new BJYException('学生可提前进入的时间不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setIsLongTerm(int $isLongTerm)
    {
        if (in_array($isLongTerm, [0, 1])) {
            ...
            throw new BJYException('长期房间标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setIsGroupLive(int $isGroupLive)
    {
        if (in_array($isGroupLive, [0, 1, 2])) {
            ...
            throw new BJYException('分组直播标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setTemplateName(string $templateName)
    {
        if (in_array($templateName, ['doubleCamera', 'classic', 'triple', 'single', 'liveWall'])) {
            ...
            throw new BJYException('模板名称不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setSpeakCameraTurnon(int $speakCameraTurnon)
    {
        if (in_array($speakCameraTurnon, [1, 2])) {
            ...
            throw new BJYException('学生发言自动开启摄像头标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setTeacherNeedDetectDevice(int $teacherNeedDetectDevice)
    {
        if (in_array($teacherNeedDetectDevice, [1, 2])) {
            ...
            throw new BJYException('老师启用设备检测标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setStudentNeedDetectDevice(int $studentNeedDetectDevice)
    {
        if (in_array($studentNeedDetectDevice, [1, 2])) {
            ...
            throw new BJYException('学生启用设备检测标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setIsVideoMain(int $isVideoMain)
    {
        if (in_array($isVideoMain, [1, 2])) {
            ...
            throw new BJYException('PC端视频标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setMIsVideoMain(int $mIsVideoMain)
    {
        if (in_array($mIsVideoMain, [1, 2])) {
            ...
            throw new BJYException('手机H5页面视频标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setIsMockLive(int $isMockLive)
    {
        if (in_array($isMockLive, [0, 1])) {
            ...
            throw new BJYException('伪直播标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setIsPushLive(int $isPushLive)
    {
        if (in_array($isPushLive, [0, 1])) {
            ...
            throw new BJYException('推流直播标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setIsWebrtcLive(int $isWebrtcLive)
    {
        if (in_array($isWebrtcLive, [0, 1])) {
            ...
            throw new BJYException('webrtc课程标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setMockRoomId(int $mockRoomId)
    {
        if ($mockRoomId >= 0) {
            ...
            throw new BJYException('伪直播回放教室号不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setMockSessionId(int $mockSessionId)
    {
        if ($mockSessionId >= 0) {
            ...
            throw new BJYException('伪直播回放教室session_id不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setMockVideoId(int $mockVideoId)
    {
        if ($mockVideoId >= 0) {
            ...
            throw new BJYException('伪直播点播视频ID不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setSwitchRoomRole(int $switchRoomRole)
    {
        if (in_array($switchRoomRole, [1, 2])) {
            ...
            throw new BJYException('大小班切换控制角色标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setEnableShare(int $enableShare)
    {
        if (in_array($enableShare, [1, 2])) {
            ...
            throw new BJYException('APP分享标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setEnableGroupUsersPublic(int $enableGroupUsersPublic)
    {
        if (in_array($enableGroupUsersPublic, [0, 1])) {
            ...
            throw new BJYException('成员名单数据权限标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setGroupAdminPermission(int $groupAdminPermission)
    {
        if (in_array($groupAdminPermission, [0, 1])) {
            ...
            throw new BJYException('助教查看答题数据权限标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setEnableGroupChatPublic(int $enableGroupChatPublic)
    {
        if (in_array($enableGroupChatPublic, [0, 1])) {
            ...
            throw new BJYException('成员聊天数据权限标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setNewGroupLive(int $newGroupLive)
    {
        if (in_array($newGroupLive, [0, 1, 2])) {
            ...
            throw new BJYException('分组标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setMockLiveRecord(int $mockLiveRecord)
    {
        if (in_array($mockLiveRecord, [0, 1])) {
            ...
            throw new BJYException('伪直播自动录制标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setEnableWeixinAuth(int $enableWeixinAuth)
    {
        if (in_array($enableWeixinAuth, [1, 2])) {
            ...
            throw new BJYException('微信授权标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }
    ...
    public function setHasStudentRaise(int $hasStudentRaise)
    {
        if (in_array($hasStudentRaise, [0, 1])) {
            ...
            throw new BJYException('学生上麦标识不合法', ErrorCode::LIVE_EDUCATION_PARAM_ERROR);
        }
    }

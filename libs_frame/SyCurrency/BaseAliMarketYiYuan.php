...
abstract class BaseAliMarketYiYuan extends BaseCommon
{
    /**
     * 请求头
     * @var array
    ...
    {
        parent::__construct();
        $authCode = 'APPCODE ' . CurrencyConfigSingleton::getInstance()->getAliMarketYiYuanConfig()->getAppCode();
    ...
    {
        $config = CurrencyConfigSingleton::getInstance()->getAliMarketYiYuanConfig();

...
class DefaultProfile
{
    ...
    {
        return AlibabaCloud::accessKeyClient($accessKeyId, $accessKeySecret)->regionId($regionId);
    }
    ...
    {
        return AlibabaCloud::ramRoleArnClient($accessKeyId, $accessKeySecret, $roleArn, $roleSessionName)->regionId($regionId);
    }
    ...
    {
        return AlibabaCloud::ecsRamRoleClient($roleName)->regionId($regionId);
    }
    ...
    {
        return AlibabaCloud::bearerTokenClient($bearerToken)->regionId($regionId);
    }
}

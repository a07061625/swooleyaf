...
class ListObjectVersionsResult extends Result
{
    ...
    protected function parseDataFromResponse()
    {
        ...
        return new ObjectVersionListInfo($bucketName, $prefix, $keyMarker, $nextKeyMarker, $versionIdMarker, $nextVersionIdMarker, $maxKeys,
            $delimiter, $isTruncated, $objectVersionList, $deleteMarkerList, $prefixList);
    }

...
class PinYin
{
    /**
     * Dict loader.
     * @var \PinYin\DictLoaderInterface
     */
    protected $loader;
    /**
     * Punctuations map.
    ...
    {
        $this->loader = $loaderName ? : 'PinYin\\FileDictLoader';
    }
    ...
    public function sentence($string, $delimiter = ' ', $option = \PINYIN_NO_TONE)
    {
        ...
        return implode($delimiter,
            $this->convert($string, $option | \PINYIN_KEEP_PUNCTUATION | \PINYIN_KEEP_ENGLISH | \PINYIN_KEEP_NUMBER));
    }

    /**
     * Loader setter.
     * @param \PinYin\DictLoaderInterface $loader
     * @return $this
     */
    ...
    /**
     * Return dict loader,.
     * @return \PinYin\DictLoaderInterface
     */
     ...
     * @param string $string
     * @param \PinYin\DictLoaderInterface $dictLoader
     * @return string
     */

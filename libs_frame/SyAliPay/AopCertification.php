...
class AopCertification
{
    ...
    private static function verifySignature($alipayCert, $rootCert) : bool
    {
        ...
        if (self::isCertSigner($alipayCertArray[0] . Project::ALIPAY_SEPARATOR_CERT_END,
            ...
            for ($i = 0; $i < $length; $i ++) {
                ...
                if ($issuer == $subject) {
                    return self::isCertSigner($alipayCertArray[1] . Project::ALIPAY_SEPARATOR_CERT_END,
        ...
        if (self::isCertSigner($alipayCertArray[1] . Project::ALIPAY_SEPARATOR_CERT_END,
    ...
    /**
     * 向上构造证书链
     * @param array|null $subjectMap 主题和证书的映射
     * @param array|null $certChain 证书链
    ...
    /**
     * 向下构造证书链
     * @param array|null $issuerMap 签发者和证书的映射
     * @param array|null $certChain 证书链

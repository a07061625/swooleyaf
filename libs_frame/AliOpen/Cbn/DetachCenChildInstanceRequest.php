...
/**
 * Request of DetachCenChildInstance
 *
 ...
 */
class DetachCenChildInstanceRequest extends RpcAcsRequest
{
     ...
     * @return $this
     */
    public function setCenOwnerId($cenOwnerId)
    {
        $this->requestParameters['CenOwnerId'] = $cenOwnerId;
        $this->queryParameters['CenOwnerId'] = $cenOwnerId;
    ...
    /**
     * @param string $childInstanceOwnerId
     *
     * @return $this
     */
    public function setChildInstanceOwnerId($childInstanceOwnerId)
    {
        $this->requestParameters['ChildInstanceOwnerId'] = $childInstanceOwnerId;
        $this->queryParameters['ChildInstanceOwnerId'] = $childInstanceOwnerId;

...
/**
 * Request of ResolveAndRouteServiceInCen
 *
 ...
 */
class ResolveAndRouteServiceInCenRequest extends RpcAcsRequest
{
    ...
    {
        $this->requestParameters['UpdateInterval'] = $updateInterval;
        $this->queryParameters['UpdateInterval'] = $updateInterval;

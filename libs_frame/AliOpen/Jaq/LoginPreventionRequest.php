...
class LoginPreventionRequest extends RpcAcsRequest
{
    private $callerName;
    private $ip;
    ...
    {
        parent::__construct('jaq', '2016-11-23', 'LoginPrevention');
    }
    ...
    public function setAccountExist($accountExist)
    {
        ...
        $this->queryParameters['AccountExist'] = $accountExist;
    }
    ...
    public function setLoginType($loginType)
    {
        ...
        $this->queryParameters['LoginType'] = $loginType;
    }
    ...
    public function setPasswordCorrect($passwordCorrect)
    {
        ...
        $this->queryParameters['PasswordCorrect'] = $passwordCorrect;
    }
}

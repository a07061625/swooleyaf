...
/**
 * Request of DescribeWhiteListStrategyList
 *
 * @method string getSourceIp()
 * @method string getStrategyIds()
 * @method string getLang()
 */
class WhiteListStrategyListDescribeRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('aegis', '2016-11-11', 'DescribeWhiteListStrategyList', 'vipaegis');
    }

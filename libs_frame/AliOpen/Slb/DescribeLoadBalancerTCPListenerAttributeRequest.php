...
class DescribeLoadBalancerTCPListenerAttributeRequest extends RpcAcsRequest
{
    public function __construct()
    {
        parent::__construct("Slb", "2014-05-15", "DescribeLoadBalancerTCPListenerAttribute", "slb", "openAPI");
        $this->setMethod("POST");
    }

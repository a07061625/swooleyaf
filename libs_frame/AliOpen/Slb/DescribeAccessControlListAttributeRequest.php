...
class DescribeAccessControlListAttributeRequest extends RpcAcsRequest
{
    public function __construct()
    {
        parent::__construct("Slb", "2014-05-15", "DescribeAccessControlListAttribute", "slb", "openAPI");
        $this->setMethod("POST");
    }
    ...
    public function getAclEntryComment()
    {

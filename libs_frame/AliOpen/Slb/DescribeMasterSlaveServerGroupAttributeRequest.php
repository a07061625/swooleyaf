...
class DescribeMasterSlaveServerGroupAttributeRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Slb', '2014-05-15', 'DescribeMasterSlaveServerGroupAttribute', 'slb', 'openAPI');
        $this->setMethod('POST');
    }

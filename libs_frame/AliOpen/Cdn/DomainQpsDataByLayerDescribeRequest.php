...
/**
 * Request of DescribeDomainQpsDataByLayer
 ...
 */
class DomainQpsDataByLayerDescribeRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Cdn', '2018-05-10', 'DescribeDomainQpsDataByLayer');
    }
    ...
    {
        $this->requestParameters['Layer'] = $layer;
        $this->queryParameters['Layer'] = $layer;

 ...
 */
class ModifyAccountPasswordRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('polardb', '2017-08-01', 'ModifyAccountPassword', 'polardb');
    }
    ...
    {
        $this->requestParameters['NewAccountPassword'] = $newAccountPassword;
        $this->queryParameters['NewAccountPassword'] = $newAccountPassword;

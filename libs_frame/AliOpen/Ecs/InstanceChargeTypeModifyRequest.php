 ...
 */
class InstanceChargeTypeModifyRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Ecs', '2014-05-26', 'ModifyInstanceChargeType', 'ecs');
    }
    ...
    {
        $this->requestParameters['IncludeDataDisks'] = $includeDataDisks;

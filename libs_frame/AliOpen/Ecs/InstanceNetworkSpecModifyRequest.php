 ...
 */
class InstanceNetworkSpecModifyRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Ecs', '2014-05-26', 'ModifyInstanceNetworkSpec', 'ecs');
    }
    ...
    {
        $this->requestParameters['NetworkChargeType'] = $networkChargeType;
    ...
    {
        $this->requestParameters['AllocatePublicIp'] = $allocatePublicIp;

 ...
 */
class VirtualBorderRoutersForPhysicalConnectionDescribeRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Ecs', '2014-05-26', 'DescribeVirtualBorderRoutersForPhysicalConnection', 'ecs');
    }

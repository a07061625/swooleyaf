 ...
 */
class LimitationDescribeRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Ecs', '2014-05-26', 'DescribeLimitation', 'ecs');
    }
    ...
    {
        $this->requestParameters['Limitation'] = $limitation;

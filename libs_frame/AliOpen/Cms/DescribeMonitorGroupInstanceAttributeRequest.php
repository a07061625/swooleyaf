...
/**
 * Request of DescribeMonitorGroupInstanceAttribute
 *
 ...
 */
class DescribeMonitorGroupInstanceAttributeRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        $this->requestParameters['Total'] = $total;

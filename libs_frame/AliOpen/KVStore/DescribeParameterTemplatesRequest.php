...
class DescribeParameterTemplatesRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('R-kvstore', '2015-01-01', 'DescribeParameterTemplates', 'redisa');
    }
    ...
    {
        $this->requestParameters['CharacterType'] = $characterType;
        $this->queryParameters['CharacterType'] = $characterType;

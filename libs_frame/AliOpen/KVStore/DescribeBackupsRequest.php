...
class DescribeBackupsRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('R-kvstore', '2015-01-01', 'DescribeBackups', 'redisa');
    }
    ...
    /**
     * @param string $needAof
     *
     * @return $this
     */
    public function setNeedAof($needAof)
    {
        $this->requestParameters['NeedAof'] = $needAof;
        $this->queryParameters['NeedAof'] = $needAof;

...
class SaveBatchTaskForCreatingOrderTransferRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Domain-intl', '2017-12-18', 'SaveBatchTaskForCreatingOrderTransfer', 'domain');
    }
    ...
    public function setOrderTransferParams(array $orderTransferParam)
    {
        ...
        foreach ($orderTransferParam as $depth1 => $depth1Value) {
            $this->queryParameters['OrderTransferParam.' . ($depth1 + 1) . '.PermitPremiumTransfer'] =
                $depth1Value['PermitPremiumTransfer'];

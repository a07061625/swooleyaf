...
class SaveBatchTaskForCreatingOrderActivateRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Domain-intl', '2017-12-18', 'SaveBatchTaskForCreatingOrderActivate', 'domain');
    }
    ...
    public function setOrderActivateParams(array $orderActivateParam)
    {
        ...
        foreach ($orderActivateParam as $depth1 => $depth1Value) {
            ...
            $this->queryParameters['OrderActivateParam.' . ($depth1 + 1) . '.PermitPremiumActivation'] =
                $depth1Value['PermitPremiumActivation'];
            ...
            $this->queryParameters['OrderActivateParam.' . ($depth1 + 1) . '.TrademarkDomainActivation'] =
                $depth1Value['TrademarkDomainActivation'];
            $this->queryParameters['OrderActivateParam.' . ($depth1 + 1) . '.AliyunDns'] = $depth1Value['AliyunDns'];
            $this->queryParameters['OrderActivateParam.' . ($depth1 + 1) . '.RegistrantOrganization'] =
                $depth1Value['RegistrantOrganization'];

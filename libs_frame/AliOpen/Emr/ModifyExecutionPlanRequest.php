 ...
 */
class ModifyExecutionPlanRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Emr', '2016-04-08', 'ModifyExecutionPlan', 'emr');
    }
    ...
    {
        $this->requestParameters['ExecutionPlanVersion'] = $executionPlanVersion;
        $this->queryParameters['ExecutionPlanVersion'] = $executionPlanVersion;

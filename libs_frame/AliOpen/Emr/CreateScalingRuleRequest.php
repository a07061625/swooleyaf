...
class CreateScalingRuleRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Emr', '2016-04-08', 'CreateScalingRule', 'emr');
    }
    ...
    public function setSchedulerTriggers(array $schedulerTriggers)
    {
        ...
        foreach ($schedulerTriggers as $i => $iValue) {
            ...
            $this->queryParameters['SchedulerTrigger.' . ($i + 1) . '.LaunchExpirationTime'] =
                $schedulerTriggers[$i]['LaunchExpirationTime'];

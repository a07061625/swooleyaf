...
/**
 * Request of GetQueueOutputStatisticInfo
 * @method string getFromDatetime()
 * @method string getResourceOwnerId()
 * @method string getClusterId()
 * @method string getToDatetime()
 */
class GetQueueOutputStatisticInfoRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Emr', '2016-04-08', 'GetQueueOutputStatisticInfo', 'emr');
    }

...
/**
 * Request of DeleteScalingTaskGroup
 * @method string getResourceOwnerId()
 * @method string getHostGroupId()
 * @method string getClusterId()
 */
class DeleteScalingTaskGroupRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Emr', '2016-04-08', 'DeleteScalingTaskGroup', 'emr');
    }

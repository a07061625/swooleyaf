...
/**
 * Request of RetryCreateUserPassword
 * @method string getResourceOwnerId()
 * @method string getClusterId()
 * @method array getUserInfos()
 */
class RetryCreateUserPasswordRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Emr', '2016-04-08', 'RetryCreateUserPassword', 'emr');
    }

 ...
 */
class ModifyFlowForWebRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Emr', '2016-04-08', 'ModifyFlowForWeb', 'emr');
    }
    ...
    {
        $this->requestParameters['Periodic'] = $periodic;
        $this->queryParameters['Periodic'] = $periodic;
    ...
    {
        $this->requestParameters['Graph'] = $graph;
        $this->queryParameters['Graph'] = $graph;

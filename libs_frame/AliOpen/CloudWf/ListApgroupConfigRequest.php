 ...
 */
class ListApgroupConfigRequest extends RpcAcsRequest
{
     ...
     * @return $this
     */
    public function setSearchCompany($searchCompany)
    {
        $this->requestParameters['SearchCompany'] = $searchCompany;
        $this->queryParameters['SearchCompany'] = $searchCompany;

...
/**
 * Request of DeleteDedicatedHostGroup
 * @method string getResourceOwnerId()
 * @method string getResourceOwnerAccount()
 * @method string getOwnerId()
 * @method string getDedicatedHostGroupId()
 */
class DedicatedHostGroupDeleteRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Rds', '2014-08-15', 'DeleteDedicatedHostGroup', 'rds');
    }

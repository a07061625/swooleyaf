...
/**
 * Request of DescribeDedicatedHostGroups
 * @method string getResourceOwnerId()
 * @method string getResourceOwnerAccount()
 * @method string getOwnerId()
 * @method string getDedicatedHostGroupId()
 */
class DedicatedHostGroupsDescribeRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Rds', '2014-08-15', 'DescribeDedicatedHostGroups', 'rds');
    }

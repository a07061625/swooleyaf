 ...
 */
class CreateOrderForDeferPreCheckRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Rds', '2014-08-15', 'PreCheckCreateOrderForDefer', 'rds');
    }
    ...
    {
        $this->requestParameters['RenewChange'] = $renewChange;
        $this->queryParameters['RenewChange'] = $renewChange;

 ...
 */
class DBInstanceNetworkTypeModifyRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Rds', '2014-08-15', 'ModifyDBInstanceNetworkType', 'rds');
    }
    ...
    {
        $this->requestParameters['ReadWriteSplittingClassicExpiredDays'] = $readWriteSplittingClassicExpiredDays;

 ...
 */
class ReadonlyInstanceDelayReplicationTimeModifyRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Rds', '2014-08-15', 'ModifyReadonlyInstanceDelayReplicationTime', 'rds');
    }

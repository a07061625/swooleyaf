 ...
 */
class GetDatabaseRequest extends RpcAcsRequest
{
    /**
     * Class constructor.
     */
    ...
    {
        parent::__construct('dms-enterprise', '2018-11-01', 'GetDatabase');
    }
    ...
    {
        $this->requestParameters['SchemaName'] = $schemaName;
        $this->queryParameters['SchemaName'] = $schemaName;

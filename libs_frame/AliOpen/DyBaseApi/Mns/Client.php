...
use AliOpen\DyBaseApi\Mns\Exception\MnsException;
use AliOpen\DyBaseApi\Mns\Requests\BaseRequest;
...
class Client
{
    ...
    public function sendRequest(BaseRequest &$request)
    {
        ...
        $result = \AliOpen\Core\Http\HttpHelper::curl(
    ...
    private function xmlToArray($xml)
    {
        ...
        return json_decode(json_encode(simplexml_load_string($xml, 'SimpleXMLElement', LIBXML_NOCDATA)), false);
    }
}

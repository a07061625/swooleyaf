...
class DescribeEventsRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Sddp', '2019-01-03', 'DescribeEvents', 'sddp');
    }
    ...
    {
        $this->requestParameters['TargetProductCode'] = $targetProductCode;
        $this->queryParameters['TargetProductCode'] = $targetProductCode;

...
class ModifyScalingRuleRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Ess', '2014-08-28', 'ModifyScalingRule', 'ess');
    }
    ...
    public function setStepAdjustments(array $stepAdjustment)
    {
        ...
        foreach ($stepAdjustment as $depth1 => $depth1Value) {
            $this->queryParameters['StepAdjustment.' . ($depth1 + 1) . '.MetricIntervalLowerBound'] =
                $depth1Value['MetricIntervalLowerBound'];
            $this->queryParameters['StepAdjustment.' . ($depth1 + 1) . '.MetricIntervalUpperBound'] =
                $depth1Value['MetricIntervalUpperBound'];

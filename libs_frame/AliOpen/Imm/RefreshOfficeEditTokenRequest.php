...
/**
 * Request of RefreshOfficeEditToken
 *
 * @method string getProject()
 * @method string getAccessToken()
 * @method string getRefreshToken()
 */
class RefreshOfficeEditTokenRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('imm', '2017-09-06', 'RefreshOfficeEditToken', 'imm');
    }

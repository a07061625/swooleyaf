...
/**
 * Request of CreateSkillGroupConfig
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class CreateSkillGroupConfigRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'CreateSkillGroupConfig');
    }

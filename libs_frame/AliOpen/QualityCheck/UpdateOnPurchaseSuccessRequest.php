...
/**
 * Request of UpdateOnPurchaseSuccess
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class UpdateOnPurchaseSuccessRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'UpdateOnPurchaseSuccess');
    }

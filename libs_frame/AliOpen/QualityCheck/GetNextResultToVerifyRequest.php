...
/**
 * Request of GetNextResultToVerify
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class GetNextResultToVerifyRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'GetNextResultToVerify');
    }

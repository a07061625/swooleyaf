...
/**
 * Request of UpdateSkillGroupConfig
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class UpdateSkillGroupConfigRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'UpdateSkillGroupConfig');
    }

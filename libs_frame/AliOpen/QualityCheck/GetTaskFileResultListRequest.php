...
/**
 * Request of GetTaskFileResultList
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class GetTaskFileResultListRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'GetTaskFileResultList');
    }

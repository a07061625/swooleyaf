...
/**
 * Request of DeleteSkillGroupConfig
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class DeleteSkillGroupConfigRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'DeleteSkillGroupConfig');
    }

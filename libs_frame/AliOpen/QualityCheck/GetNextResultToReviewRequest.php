...
/**
 * Request of GetNextResultToReview
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class GetNextResultToReviewRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'GetNextResultToReview');
    }

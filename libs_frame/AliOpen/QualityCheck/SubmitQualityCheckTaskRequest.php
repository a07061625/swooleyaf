...
/**
 * Request of SubmitQualityCheckTask
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class SubmitQualityCheckTaskRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'SubmitQualityCheckTask');
    }

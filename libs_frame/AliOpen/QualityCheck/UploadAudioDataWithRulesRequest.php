...
/**
 * Request of UploadAudioDataWithRules
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class UploadAudioDataWithRulesRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'UploadAudioDataWithRules');
    }

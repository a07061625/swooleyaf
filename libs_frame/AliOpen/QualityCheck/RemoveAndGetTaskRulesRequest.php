...
/**
 * Request of RemoveAndGetTaskRules
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class RemoveAndGetTaskRulesRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'RemoveAndGetTaskRules');
    }

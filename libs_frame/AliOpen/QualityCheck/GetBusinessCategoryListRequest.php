...
/**
 * Request of GetBusinessCategoryList
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class GetBusinessCategoryListRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'GetBusinessCategoryList');
    }

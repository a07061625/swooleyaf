...
/**
 * Request of ReviewSingleResultById
 *
 * @method string getResourceOwnerId()
 * @method string getJsonStr()
 */
class ReviewSingleResultByIdRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Qualitycheck', '2019-01-15', 'ReviewSingleResultById');
    }

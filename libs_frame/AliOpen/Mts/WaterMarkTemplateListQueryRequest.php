...
/**
 * Request of QueryWaterMarkTemplateList
...
class WaterMarkTemplateListQueryRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Mts', '2014-06-18', 'QueryWaterMarkTemplateList', 'mts');
    }
    ...
    {
        $this->requestParameters['WaterMarkTemplateIds'] = $waterMarkTemplateIds;

...
class VideoGifJobSubmitRequest extends RpcAcsRequest
{
    ...
    {
        parent::__construct('Mts', '2014-06-18', 'SubmitVideoGifJob', 'mts');
    }
    ...
    /**
     * @param string $videoGifConfig
     * @return $this
     */
    public function setVideoGifConfig($videoGifConfig)
    {
        $this->requestParameters['VideoGifConfig'] = $videoGifConfig;

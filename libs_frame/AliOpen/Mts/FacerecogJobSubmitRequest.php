 ...
 */
class FacerecogJobSubmitRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Mts', '2014-06-18', 'SubmitFacerecogJob', 'mts');
    }
    ...
    {
        $this->requestParameters['FacerecogConfig'] = $facerecogConfig;
        $this->queryParameters['FacerecogConfig'] = $facerecogConfig;

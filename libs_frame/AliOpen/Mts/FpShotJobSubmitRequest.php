...
class FpShotJobSubmitRequest extends RpcAcsRequest {
    private $input;
    private $userData;
    private $resourceOwnerId;
    private $fpShotConfig;
    ...
    public function __construct(){
        parent::__construct("Mts", "2014-06-18", "SubmitFpShotJob", "mts", "openAPI");
        $this->setMethod("POST");
    }
    ...
    public function getFpShotConfig(){

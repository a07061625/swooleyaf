 ...
 */
class CreateBgpPeerRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Vpc', '2016-04-28', 'CreateBgpPeer', 'vpc');
    }
    ...
    {
        $this->requestParameters['PeerIpAddress'] = $peerIpAddress;
        $this->queryParameters['PeerIpAddress'] = $peerIpAddress;

...
/**
 * Request of CreatePhysicalConnectionNew
 *
 ...
 */
class CreatePhysicalConnectionNewRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('Vpc', '2016-04-28', 'CreatePhysicalConnectionNew', 'vpc');
    }
    ...
    {
        $this->requestParameters['InterfaceName'] = $interfaceName;
        $this->queryParameters['InterfaceName'] = $interfaceName;

...
/**
 * Request of PostRealTimeDeviceData
 *
 * @method string getData()
 * @method string getServiceId()
 */
class PostRealTimeDeviceDataRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('industry-brain', '2018-07-12', 'PostRealTimeDeviceData');
    }

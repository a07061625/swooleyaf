 ...
 */
class GetInstanceRequest extends RoaAcsRequest
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $uriPattern = '/api/v2/projects/[projectName]/jobs/[jobName]/instances/[instanceId]';
    ...
    {
        parent::__construct('foas', '2018-11-11', 'GetInstance', 'foas');
    }

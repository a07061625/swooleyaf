...
/**
 * Request of DescribeGroupHighRiskAcl
 *
 ...
 */
class DescribeGroupHighRiskAclRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'DescribeGroupHighRiskAcl', 'ecs');
    }
    ...
    {
        $this->requestParameters['AlarmLevel'] = $alarmLevel;
        $this->queryParameters['AlarmLevel'] = $alarmLevel;

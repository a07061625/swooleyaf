...
/**
 * Request of InnerEcsReleaseByDriver
 ...
 */
class InnerEcsReleaseByDriverRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'InnerEcsReleaseByDriver', 'ecs');
    }

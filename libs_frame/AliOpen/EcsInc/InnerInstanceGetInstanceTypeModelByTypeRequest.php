...
/**
 * Request of InnerInstanceGetInstanceTypeModelByType
 ...
 */
class InnerInstanceGetInstanceTypeModelByTypeRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'InnerInstanceGetInstanceTypeModelByType', 'ecs');
    }
    ...
    {
        $this->requestParameters['includeOffline'] = $includeOffline;
        $this->queryParameters['includeOffline'] = $includeOffline;

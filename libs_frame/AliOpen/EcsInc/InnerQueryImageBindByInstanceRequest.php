 ...
 */
class InnerQueryImageBindByInstanceRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'InnerQueryImageBindByInstance', 'ecs');
    }
    ...
    {
        $this->requestParameters['BindStatuss'] = $bindStatuss;
        foreach ($bindStatuss as $i => $iValue) {
            $this->queryParameters['BindStatus.' . ($i + 1)] = $iValue;
        }

 ...
 */
class DescribeResourceCreationCapacityRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'DescribeResourceCreationCapacity', 'ecs');
    }
    ...
    {
        $this->requestParameters['DataDiskCategorys'] = $dataDiskCategorys;
        foreach ($dataDiskCategorys as $i => $iValue) {
            $this->queryParameters['DataDiskCategory.' . ($i + 1)] = $iValue;
        }

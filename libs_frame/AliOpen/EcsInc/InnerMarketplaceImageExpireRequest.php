 ...
 */
class InnerMarketplaceImageExpireRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'InnerMarketplaceImageExpire', 'ecs');
    }
    ...
    {
        $this->requestParameters['ImageInstanceId'] = $imageInstanceId;
        $this->queryParameters['ImageInstanceId'] = $imageInstanceId;

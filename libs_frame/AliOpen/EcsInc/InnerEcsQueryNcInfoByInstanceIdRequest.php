...
/**
 * Request of InnerEcsQueryNcInfoByInstanceId
 ...
 */
class InnerEcsQueryNcInfoByInstanceIdRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'InnerEcsQueryNcInfoByInstanceId', 'ecs');
    }

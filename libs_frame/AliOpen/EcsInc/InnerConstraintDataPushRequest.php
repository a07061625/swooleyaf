...
/**
 * Request of InnerConstraintDataPush
 *
 ...
 */
class InnerConstraintDataPushRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'InnerConstraintDataPush', 'ecs');
    }
    ...
    {
        $this->requestParameters['filePath'] = $filePath;
        $this->queryParameters['filePath'] = $filePath;

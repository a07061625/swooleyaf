...
/**
 * Request of InnerImageModifyProductCapacity
 ...
 */
class InnerImageModifyProductCapacityRequest extends RpcAcsRequest
{
    /**
     * @var string
     */
    ...
    {
        parent::__construct('EcsInc', '2016-03-14', 'InnerImageModifyProductCapacity', 'ecs');
    }

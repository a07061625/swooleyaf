 ...
 */
class DescribeProjectsRequest extends RpcAcsRequest
{
    /**
     * Class constructor.
     */
    ...
    {
        parent::__construct('ivision', '2019-03-08', 'DescribeProjects', 'ivision');
    }
    ...
    {
        $this->requestParameters['ProjectIds'] = $projectIds;

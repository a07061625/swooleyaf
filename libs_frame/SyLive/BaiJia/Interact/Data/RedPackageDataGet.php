...
/**
 * Class RedPackageDataGet
 * @package SyLive\BaiJia\Interact\Data
 */
class RedPackageDataGet extends BaseBaiJia
{
    /**
     * 房间ID
     * @var int
    ...
    public function __construct(string $partnerId)
    {
        ...
        $this->serviceUri = '/openapi/interact_data/getRedPackageData';
        $this->reqData['page'] = 1;
    ...
    public function setType(int $type)
    {
        if (in_array($type, [0, 1])) {
            ...
            throw new BaiJiaException('红包类型不合法', ErrorCode::LIVE_BAIJIA_PARAM_ERROR);
        }
    }

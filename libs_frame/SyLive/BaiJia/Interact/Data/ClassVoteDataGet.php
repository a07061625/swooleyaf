 ...
 */
class ClassVoteDataGet extends BaseBaiJia
{
    /**
     * 房间ID
     * @var int
    ...
    public function setType(int $type)
    {
        if (in_array($type, [0, 1])) {
            ...
            throw new BaiJiaException('题型不合法', ErrorCode::LIVE_BAIJIA_PARAM_ERROR);
        }
    }
    ...
    public function setSubType(int $subType)
    {
        if (in_array($subType, [0, 1, 2])) {
            ...
            throw new BaiJiaException('题目类型不合法', ErrorCode::LIVE_BAIJIA_PARAM_ERROR);
        }
    }

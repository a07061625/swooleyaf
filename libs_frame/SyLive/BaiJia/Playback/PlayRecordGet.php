 ...
 */
class PlayRecordGet extends BaseBaiJia
{
    /**
     * 房间ID
     * @var int
    ...
    public function setTime(int $startTime, int $endTime)
    {
        if ($startTime <= 0) {
            ...
            throw new BaiJiaException('结束时间不能大于起始时间24小时', ErrorCode::LIVE_BAIJIA_PARAM_ERROR);
        }
    ...
    public function getDetail() : array
    {
        ...
        if (!isset($this->reqData['start_time'])) {
            throw new BaiJiaException('起始时间不能为空', ErrorCode::LIVE_BAIJIA_PARAM_ERROR);
        }

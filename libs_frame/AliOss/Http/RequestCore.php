...
class RequestCore {
     ...
     */
    public $request_class = 'AliOss\Http\RequestCore';
    /**
     * The default class to use for HTTP Responses (defaults to <ResponseCore>).
     */
    public $response_class = 'AliOss\Http\ResponseCore';
    /**
    ...
    public function streaming_read_callback($curl_handle, $file_handle, $length){
        ...
        $read = fread($this->read_stream,
            min($this->read_stream_size - $this->read_stream_read, $length)); // Remaining upload data or cURL's requested chunk size
    ...
    public function send_request($parse = false){
        ...
        if ($this->response === false) {
            throw new RequestCore_Exception('cURL resource: ' . (string)$curl_handle . '; cURL error: ' . curl_error($curl_handle) . ' ('

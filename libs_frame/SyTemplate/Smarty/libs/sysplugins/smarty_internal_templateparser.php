...
class Smarty_Internal_Templateparser
{
    ...
    public function yy_r1()
    {
        $code =
            $this->compiler->compileTag(
                'private_php',
                [['code' => $this->yystack[ $this->yyidx + 0 ]->minor], ['type' => $this->lex->phpType]],
                []
            );
        if ($this->compiler->has_code && !empty($code)) {
            ...
            $this->compiler->prefix_code = [];
            $this->current_buffer->append_subtree(
                $this,
    ...
    public function yy_r14()
    {
        ...
        if ($this->yystack[ $this->yyidx + 0 ]->minor[ $j + 1 ] == 'c') {
            // {$smarty.block.child}
            $this->_retvalue =
                $this->compiler->compileTag('child', [], [$this->yystack[ $this->yyidx + 0 ]->minor]);
        } else {
            // {$smarty.block.parent}
            $this->_retvalue =
                $this->compiler->compileTag('parent', [], [$this->yystack[ $this->yyidx + 0 ]->minor]);
        }
    }
    ...
    public function yy_r17()
    {
        $this->_retvalue =
            $this->compiler->compileTag(
                ...
                ['value' => $this->yystack[ $this->yyidx + 0 ]->minor[ 0 ]]
            );
    }
    ...
    {
        $this->_retvalue =
            $this->compiler->compileTag('assign', array_merge([
                ['value' => $this->yystack[ $this->yyidx + 0 ]->minor[ 0 ]],
    ...
    public function yy_r19()
    {
        $this->_retvalue =
            $this->compiler->compileTag('assign', array_merge([
                ['value' => $this->yystack[ $this->yyidx + 0 ]->minor[ 0 ]],
                ['var' => $this->yystack[ $this->yyidx + -1 ]->minor[ 'var' ]]
            ], $this->yystack[ $this->yyidx + 0 ]->minor[ 1 ]), [
    ...
    public function yy_r31()
    {
        ...
        $this->_retvalue =
            $this->compiler->compileTag(
                ...
                [],
                ['if condition' => $this->yystack[ $this->yyidx + 0 ]->minor]
            );
    }
    ...
    {
        $this->_retvalue =
            $this->compiler->compileTag('for', array_merge($this->yystack[ $this->yyidx + 0 ]->minor, [
                ['start' => $this->yystack[ $this->yyidx + -6 ]->minor],
                ['ifexp' => $this->yystack[ $this->yyidx + -4 ]->minor],
                ['var' => $this->yystack[ $this->yyidx + -2 ]->minor],
                ['step' => $this->yystack[ $this->yyidx + -1 ]->minor]
            ]), 1);
    }
    ...
    public function yy_r38()
    {
        $this->_retvalue =
            $this->compiler->compileTag('for', array_merge($this->yystack[ $this->yyidx + 0 ]->minor, [
                ['start' => $this->yystack[ $this->yyidx + -3 ]->minor],
                ['to' => $this->yystack[ $this->yyidx + -1 ]->minor]
            ]), 0);
    }
    ...
    public function yy_r39()
    {
        $this->_retvalue =
            $this->compiler->compileTag('for', array_merge($this->yystack[ $this->yyidx + 0 ]->minor, [
                ['start' => $this->yystack[ $this->yyidx + -5 ]->minor],
                ['to' => $this->yystack[ $this->yyidx + -3 ]->minor],
                ['step' => $this->yystack[ $this->yyidx + -1 ]->minor]
            ]), 0);
    }
    ...
    {
        $this->_retvalue =
            $this->compiler->compileTag('foreach', array_merge($this->yystack[ $this->yyidx + 0 ]->minor, [
                ['from' => $this->yystack[ $this->yyidx + -3 ]->minor],
                ['item' => $this->yystack[ $this->yyidx + -1 ]->minor]
            ]));
    }
    ...
    public function yy_r41()
    {
        $this->_retvalue =
            $this->compiler->compileTag('foreach', array_merge($this->yystack[ $this->yyidx + 0 ]->minor, [
                ['from' => $this->yystack[ $this->yyidx + -5 ]->minor],
                ['item' => $this->yystack[ $this->yyidx + -1 ]->minor],
                ['key' => $this->yystack[ $this->yyidx + -3 ]->minor]
            ]));
    }
    ...
    public function yy_r48()
    {
        $this->_retvalue =
            $this->compiler->compileTag(
                ...
                [],
                ['object_method' => $this->yystack[ $this->yyidx + 0 ]->minor]
            );
    }
    ...
    {
        if (!in_array(strtolower($this->yystack[ $this->yyidx + -2 ]->minor), ['self', 'parent']) &&
            (!$this->security ||
    ...
    public function yy_r122()
    {
        $this->_retvalue =
            '[' .
            $this->compiler->compileTag('private_special_variable', [], '[\'section\'][\'' .
                                                                             $this->yystack[ $this->yyidx +
                                                                                             -3 ]->minor .
                                                                             '\'][\'' .
                                                                             $this->yystack[ $this->yyidx +
    ...
    {
        $this->_retvalue =
            $this->compiler->compilePHPFunctionCall(
                $this->yystack[ $this->yyidx + -3 ]->minor,
                $this->yystack[ $this->yyidx + -1 ]->minor
            );
    }
    ...
    {
        $this->_retvalue =
            [trim($this->yystack[ $this->yyidx + -1 ]->minor) . $this->yystack[ $this->yyidx + 0 ]->minor];
    }

...
class DeviceUnbind extends PrintBaseFeYin
{
    /**
     * 应用ID
     * @var string
    ...
    public function getDetail() : array
    {
        ...
        $this->curlConfigs[CURLOPT_URL] = $this->serviceDomain . '/device/' . $this->device_no . '/unbind?access_token=' . PrintUtilFeYin::getAccessToken($this->appid);
